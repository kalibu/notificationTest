...
@Service
@Slf4j
public class PushNotificationNotification extends AbstractNotification {

    public void notifySubscribed(User user, String message) {
        log.info("Sending Push Notification notification for user: {}, phoneNumber: {}, message: {}", user.getName(), user.getPhoneNumber(), message);
    }
}
